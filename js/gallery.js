...
Date: 2025-02-23
Description: This is the gallery javascript file that contains the functionalities for the gallery page.
...
window.addEventListener("load", async function (name) {
    /**
