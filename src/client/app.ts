...
import {
    ...
    handleCancelClick,
    handleEditClick,
    AddContact, getFromStorage, removeFromStorage
} from "./utils.js";
...
(function () {
    ...
    async function DisplayEditPage():Promise<void> {
        ...
        const page: string = hashParts.length > 2 ? hashParts[2] : "add";
        // Add a new contact
        const pageTitle = document.querySelector("main>h1") as HTMLElement;
        ...
        addEventListenerOnce("editButton", "click", async(event) => {
            ...
            if(page === "add"){
                ...
                const contactNumber: string = (document.getElementById("contactNumber") as HTMLInputElement).value.trim();
                const emailAddress: string = (document.getElementById("emailAddress") as HTMLInputElement).value.trim();
    ...
    async function DisplayContactListPage() {
        ...
        try{
            ...
            const addButton: HTMLButtonElement | null = document.getElementById("addButton") as HTMLButtonElement;
